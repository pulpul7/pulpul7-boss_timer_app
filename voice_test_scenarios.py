...
VOICE_TEST_SCENARIOS = (
    ...
    scenario("11", "동시간 고정보스·후속 안내 없음", (("라이노르", 780, False),),
             fixed=(("지옥성채 정예", 60), ("핏빛고블린", 60)), fixed_offsets=(60,), watch=15,
             detail="지옥성채 정예·핏빛고블린 이름과 1분전만 안내. 뒤에 다음 보스 안내가 붙지 않아야 함."),
    scenario("11-1", "발할라 시작·월드보스 사전 안내", (("라이노르", 780, False),),
             fixed=(("발할라 대전", 60), ("월드보스", 70)), fixed_offsets=(60,), watch=24,
             detail="발할라 시작·월드보스 1분전에는 다음 보스를 안내하지 않음. 다음 보스 안내는 별도 발할라 종료 1분전 전용."),
